# Generated by Django 3.2.4 on 2021-09-02 19:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('typeExpression', models.CharField(choices=[('UPPER', 'UPPER'), ('CONCAT', 'CONCAT'), ('CASE', 'CASE'), ('SUM', 'SUM')], max_length=30, null=True)),
